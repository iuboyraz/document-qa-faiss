...
from langchain.vectorstores import FAISS  # Chroma yerine FAISS kullanıyoruz
...
# Upload Excel file
excel_file = r"/workspaces/document-qa-faiss/chatbot_techpro_final_questions.xlsx"
